              ...
              {histories.map((item) => (
                <GlowingShadow key={item.id} className="w-full">
                  <motion.div
                    ...
                    className="w-full bg-white/90 dark:bg-[#111] p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 flex flex-col h-full relative overflow-hidden group"
                  >
                      ...
                      <div className="relative">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <button
                            onClick={(e) => {
                              e.preventDefault();
                              const text = item.paraphrased_text;
