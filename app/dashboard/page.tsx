...
export default function Dashboard() {
  ...
  if (loading) return <div className="min-h-screen flex flex-col gap-6 items-center justify-center dark:bg-[#0A0A0A]"><DashboardLoader /><span className="text-gray-500 font-medium">Loading dashboard...</span></div>;
